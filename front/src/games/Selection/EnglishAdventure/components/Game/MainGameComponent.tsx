...
interface EnglishAdventureComponentProps {
    levelCount: number;
    setLevelCount: (level: number) => void;
}

const EnglishAdventureComponent = ({ levelCount, setLevelCount }: EnglishAdventureComponentProps) => {
...
export default EnglishAdventureComponent;
