...
interface DisneyQuizComponentProps {
    levelCount: number;
    setLevelCount: (level: number) => void;
}

const DisneyQuizComponent = ({ levelCount, setLevelCount }: DisneyQuizComponentProps) => {
...
export default DisneyQuizComponent;
